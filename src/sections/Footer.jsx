      ...
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            The Divine Pizza Restaurant has been serving up the healthiest and
            tastiest wood fired pizza since 2010.
          </p>
      ...
      <div className="flex justify-center  text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex justify-center items-center gap-2 font-montserrat">
          <p className="items-center text-center">
            Copyright Divine Pizza Restaurant. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
